...
>
    <x-page-title title="Ajouter un agent" subtitle="Créer un compte agent lié à une direction." />

    <form method="POST" action="{{ route('admin.agents.store') }}" class="max-w-3xl space-y-5 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        @csrf
        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <x-primary-button>Ajouter l’agent</x-primary-button>
        </div>
    </form>
</x-aadl-layout>
